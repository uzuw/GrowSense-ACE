        ...
        <section className="py-16 bg-[#e8f5e9] text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="p-6 bg-white rounded-lg transform hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
              <span className="text-5xl text-[#2a7d2e] mb-4 block mx-auto">🌱</span>
            ...
            <div className="p-6 bg-white rounded-lg transform hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
              <span className="text-5xl text-[#2a7d2e] mb-4 block mx-auto">🖥️</span>
        ...
        <section id="contact" className="flex flex-col lg:flex-row gap-12 py-16">
          <div className="flex-1">
            ...
            <p className="flex items-center text-lg mb-4">
              <span className="text-[#2a7d2e] mr-4 text-xl">📞</span> Phone: +977-98XXXXXXXX
            </p>
            <p className="flex items-center text-lg mb-4">
              <span className="text-[#2a7d2e] mr-4 text-xl">✉️</span> Email: support@growsense.com
            </p>
            <p className="flex items-center text-lg mb-4">
              <span className="text-[#2a7d2e] mr-4 text-xl">📍</span> Address: GrowSense Agriculture Tech Pvt. Ltd., Kathmandu, Nepal
            </p>
            <p className="flex items-center text-lg mb-4">
              <span className="text-[#2a7d2e] mr-4 text-xl">⏰</span> Hours: Mon-Fri, 9:00 AM – 5:00 PM
            </p>
          </div>
          <div className="flex-1">
        ...
        <section className="py-16 bg-[#e8f5e9] text-center">
          ...
          <div className="flex justify-center gap-8 flex-wrap">
            <a href="#" className="flex items-center text-lg font-medium text-[#2a7d2e] hover:text-[#1b5e20] transition-colors">
              <span className="mr-2 text-xl">📖</span> User Guide
            </a>
            <a href="#" className="flex items-center text-lg font-medium text-[#2a7d2e] hover:text-[#1b5e20] transition-colors">
              <span className="mr-2 text-xl">🎥</span> Video Tutorials
            </a>
            <a href="#" className="flex items-center text-lg font-medium text-[#2a7d2e] hover:text-[#1b5e20] transition-colors">
              <span className="mr-2 text-xl">🛠️</span> Device Installation Manual
            </a>
          </div>
        </section>
      </main>
